...
// Simple CLI for managing Seashell configuration
...
func showHelp() {
    print("""
    Seashell Configuration Manager
...
func showConfig() {
    guard FileManager.default.fileExists(atPath: configFile.path) else {
        ...
        print("Run 'seashell --init-config' to create one.")
        return
    }
...
case .reset:
    resetConfig()
case .validate:
    print("Run 'seashell --validate-config' to validate configuration")
case .help:
    showHelp()
}
