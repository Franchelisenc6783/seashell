#!/usr/bin/env python3
"""
Example client for testing Seashell MCP Server
...
def send_command(host='127.0.0.1', port=9876, command_data=None):
    """Send a command to the Seashell server"""
    try:
...
def main():
    """Example usage of the Seashell client"""
    
    print("Seashell - Example Client")
    print("=====================================\n")
    ...
    response = send_command(command_data={
        "type": "execute",
        "command": "echo 'Hello from Seashell!'",
